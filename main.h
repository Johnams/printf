 ...
 * @fmt: format
 * @fm_t: teh function associated
 */
typedef struct fmt fmt_t;

int _printf(const char *format, ...);
int handle_per(const char *fmt, int *i,
		int _printf(const char *format, ...);
...
int print_string(va_list types, char buffer[],
	int flags, int width, int precision, int size);
int print_percent(va_list types, int buffer[],
	int flags, int width, int precision, int size);
...
/*Function to print nun printable characters*/
...
int print_reverse(va_list types, char buffer[],
		int flags, int prcision, int size);
/*Function to print a string in rot 13*/
int print_rot13string(va_list types, char buffer[],
		int flags, int width, int precision, int size);
/*Width handler*/
int handle_write_char(char c, char buffer[],
		int flsgs, int width, int size);
...
int write_pointer(char buffer[], int ind, int length,
		int width, int flags, char padd, char etra_c, int padd_start);
